        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8 text-black">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Download and use our mobile application (BadHealth), or any other application of ours that links to this Privacy Notice</li>
              <li>Use BadHealth. A consumer health application that scans someone's fridge and gives them a food to eat based on the ingredients available. There are other features such as getting grocery lists, learning about topics, and others.</li>
              <li>Engage with us in other related ways, including any sales, marketing, or events</li>
            </ul>

            <p>
              <strong>Questions or concerns?</strong> Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at Gabriel@badhealthapp.com.
            </p>

            <h2 className="text-2xl font-bold mt-12 mb-4">SUMMARY OF KEY POINTS</h2>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">1. WHAT INFORMATION DO WE COLLECT?</h2>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?</h2>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">5. DO WE OFFER ARTIFICIAL INTELLIGENCE-BASED PRODUCTS?</h2>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h2>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">7. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">8. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">9. DO WE COLLECT INFORMATION FROM MINORS?</h2>
            ...
            <p>
              We do not knowingly collect, solicit data from, or market to children under 18 years of age, nor do we knowingly sell such personal information. If you become aware of any data we may have collected from children under age 18, please contact us at Gabriel@badhealthapp.com.
            </p>

            <h2 className="text-2xl font-bold mt-12 mb-4">10. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
            ...
            <p>
              If you would at any time like to review or change the information in your account or terminate your account, you can click a button on the settings page called delete account.
            </p>
            ...
            <p>
              If you have questions or comments about your privacy rights, you may email us at Gabriel@badhealthapp.com.
            </p>

            <h2 className="text-2xl font-bold mt-12 mb-4">11. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>

            <p>
              Most web browsers and some mobile operating systems and mobile applications include a Do-Not-Track ("DNT") feature or setting you can activate to signal your privacy preference not to have data about your online browsing activities monitored and collected.
            </p>

            <h2 className="text-2xl font-bold mt-12 mb-4">12. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">13. DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?</h2>

            <p className="italic">
              <strong>In Short:</strong> You may have additional rights based on the country you reside in.
            </p>

            <h2 className="text-2xl font-bold mt-12 mb-4">14. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
            ...
            <h2 className="text-2xl font-bold mt-12 mb-4">15. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>

            <p>
              If you have questions or comments about this notice, you may email us at Gabriel@badhealthapp.com or contact us by post at:
            </p>

            <div className="pl-6">
              <p>Life Satisfaction LLC</p>
              <p>2314 Peacock valley rd</p>
              <p>Chula Vista, CA 91915</p>
              <p>United States</p>
            </div>

            <h2 className="text-2xl font-bold mt-12 mb-4">16. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
